...
void LiRate_reconstructed (){
    ...
    Int_t evtID, NTracks, NPoints[50];
    Double_t PointX[50];
    Double_t PointY[50];
    Double_t PointZ[50];
    Double_t Coeff0[50];
    ...
    TBranch *b_evtID, *b_NTracks, *b_NPoints, *b_PointX, *b_PointY, *b_PointZ, *b_Coeff0, *b_Coeff1, *b_Coeff2, *b_Coeff3, *b_Coeff4, *b_Coeff5;
    ...
    myChain->SetBranchAddress ("NPoints",&NPoints, &b_NPoints);
    myChain->SetBranchAddress ("PointX",&PointX, &b_PointX);
    myChain->SetBranchAddress ("PointY",&PointY, &b_PointY);
    myChain->SetBranchAddress ("PointZ",&PointZ, &b_PointZ);
